...
// ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->generatedTweets[] = $this->generateWallet("Vacances");
        $this->generatedTweets[] = $this->generateWallet("Colloc");
        $this->generatedTweets[] = $this->generateWallet("Montagne");

        // now, generate 5 expenses per wallets
        foreach ($this->generatedTweets as $wallet) {
